        ...
        function widget( $args, $instance ) {
            ...
            echo $args['before_widget']; ?>
                ...
                <div class="pt-portfolio-main">
                    ...
                    pt_theme_addon_portfolio_widget_call( $post_category, $post_number, $post_column, $featured_image ); ?>
...
function pt_theme_addon_portfolio_widget_call( $post_category, $post_number, $post_column, $featured_image ){
...
function pt_theme_addon_show_portfolio( $atts ) {
    ...
    pt_theme_addon_portfolio_widget_call( $category, $post_number, $column, $image_size );
