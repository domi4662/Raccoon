<?php
    class gallery_blocks {
        ...
        public function build_gallery_blocks( $block = 'gallery_block1', $options = array(), $post_count, $total_post ) {
            require_once( RIGEL_BLOCKS_DIR. '/gallery-blocks/blocks/gallery-block.php' );
        ...
        public function gallery_modules( $style = 'style1', $options, $size ) {
            require_once( RIGEL_BLOCKS_DIR. '/gallery-blocks/style/'. $style .'.php' );
        ...
        public function get_image_thumb( $image_id, $block = 'gallery_block1', $post_count ) {
            ...
            //Get Porfolio Image
            $thumb = !empty( $image_id ) ? $this->get_image_by_id( $size['width'], $size['height'], $image_id, 1, 1, 1 ) : '';
    ...
    require_once( RIGEL_BLOCKS_DIR .          '/gallery-blocks/gallery-block-shortcode.php' );

    // Gallery Block Extend Vc
    require_once( RIGEL_BLOCKS_DIR .          '/gallery-blocks/gallery-block-vc.php' );