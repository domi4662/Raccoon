<?php
    ...
    $video_methods = rigel_get_meta_value( get_the_ID(), '_amz_video_methods', 'normal' );
    $video_normal = rigel_get_meta_value( get_the_ID(), '_amz_video_normal', '' );
    $poster = rigel_get_meta_value( get_the_ID(), '_amz_poster', '' );
    $video_autoplay = rigel_get_meta_value( get_the_ID(), '_amz_video_autoplay', 'no' );
    $video_iframe = rigel_get_meta_value( get_the_ID(), '_amz_video_iframe', '' );
