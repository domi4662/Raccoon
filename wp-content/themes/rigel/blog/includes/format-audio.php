<?php
    ...
    $audio_methods = rigel_get_meta_value( get_the_ID(), '_amz_audio_methods', 'normal' );
    $audio_normal = rigel_get_meta_value( get_the_ID(), '_amz_audio_normal', '' );
    $audio_autoplay = rigel_get_meta_value( get_the_ID(), '_amz_audio_autoplay', 'no' );
    $audio_iframe = rigel_get_meta_value( get_the_ID(), '_amz_audio_iframe', '' );
