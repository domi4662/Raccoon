<div class="wrap" id="of_container">
	...
	<div id="of-popup-save" class="of-save-popup">
		<div class="of-save-save"><i class="icon-check-mark"></i> <?php _e('Options Updated','rigel' );?></div>
	</div>
	
	<div id="of-popup-reset" class="of-save-popup">
		<div class="of-save-reset"><i class="icon-refresh"></i> <?php _e('Options Reset','rigel' ); ?></div>
	</div>
	
	<div id="of-popup-fail" class="of-save-popup">
		<div class="of-save-fail"><i class="icon-remove"></i> <?php _e('Error! Not Saved','rigel' ); ?></div>
	</div>
	...
	<form id="of_form" method="post" action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" enctype="multipart/form-data" >
		...
		<div id="header">
			...
			<div class="logo">
				<!-- <h2><?php //echo RIGELNAME; ?></h2>
				<span><?php //echo ('v'. RIGELVERSION); ?></span> -->
				<img src="<?php echo ADMIN_DIR; ?>assets/images/theme-options-logo.png" class="" alt="Working..." />
			</div>
		
			<div id="js-warning"><?php _e('Warning- This options panel will not work properly without javascript!','rigel' ); ?></div>
		...
		<div id="main">
			...
			<div id="content">
				<div id="no-result" class="section-info">
					<div class="controls">
						<div class="of-info">
							<h3><?php _e('No Result Found!', 'rigel' ); ?></h3>
						</div>
					</div>
				</div>
				...
				<div class="save_bar"> 
					...
					<button id ="of_save" type="button" class="btn-sec"><i class="pix-icon icon-pix-fonts-22"></i> <?php _e('Save All Changes', 'rigel' );?></button>			
					<button id ="of_reset" type="button" class="button submit-button reset-button" ><?php _e('Options Reset', 'rigel' );?></button>
