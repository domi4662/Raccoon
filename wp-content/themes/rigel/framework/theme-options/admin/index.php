...
define( 'RIGELNAME', $theme_name );
/* Theme version, uri, and the author uri are not completely necessary, but may be helpful in adding functionality */
define( 'RIGELVERSION', $theme_version );
define( 'RIGELURI', $theme_uri );
define( 'RIGELAUTHORURI', $author_uri );
 ...
 * @since 1.0.0
 */ 
rigel_require_file( ADMIN_PATH . 'functions/functions.load.php' );
rigel_require_file( ADMIN_PATH . 'classes/class.options_machine.php' );
