...
$output .= "\n\t".'<div class="'. esc_attr( $css_class ).' pix_accordion '. esc_attr( $style ) .'" data-collapsible="'. esc_attr( $collapsible ) .'" data-vc-disable-keydown="' . ( esc_attr( ( 'yes' == $disable_keyboard ? 'true' : 'false' ) ) ) . '" data-active-tab="'. esc_attr( $active_tab ) .'">'; //data-interval="'.$interval.'"
