 ...
 * @return      void
*/
class Rigel_Menu_Extend_Walker extends Walker_Nav_Menu
{
    private $img;
    ...
    $item_output .= $icon . $args->link_before . '<span class="inner-menu"><span data-letters="'. esc_attr( apply_filters( 'the_title', $item->title, $item->ID ) ).'">'. apply_filters( 'the_title', $item->title, $item->ID ) .'</span></span>'. $args->link_after;
    $item_output .= '</a>';
