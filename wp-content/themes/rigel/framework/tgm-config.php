...
function rigel_register_required_plugins() {
	...
	$plugins = array(
		...
		// Rigel Core Plugin
		array(
			'name' => 'Rigel Core Plugins',
			'slug' => 'amz-rigel-plugins',
			'source' => get_template_directory() . '/framework/plugins/amz-rigel-plugins.zip',
			'required' => true,
			'version' => '1.5.1',
		...
		// Revolution Slider
		array(
			'name' => esc_html__('Revolution Slider', 'rigel'),
			'slug' => 'revslider',
		...
		array(
			'name' => esc_html__('WP Envato Market', 'rigel'),
		...
		array(
			'name' => esc_html__('Rigel Blocks & Vc Copy Paster', 'rigel'),
